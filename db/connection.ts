...
db.exec(`
  ...
  -- Per-user library reading position
  ...
  -- Persistent revoked token blacklist
  ...
  -- Chapter page URL cache with TTL
  ...
  -- Cross-Series Story Arcs & Custom Readlists
  ...
  -- Persistent Chapter Download Queue
